...
func (h webuiHandler) setSecurityHeaders(w http.ResponseWriter) {
	...
	w.Header().Set("Content-Security-Policy", "default-src 'self'; style-src 'self' 'unsafe-inline'; script-src 'self' 'unsafe-inline' 'unsafe-eval' http://www.google.com; img-src 'self' data: https:; font-src 'self' data:")
}
